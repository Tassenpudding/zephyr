...
+---------------+----------+-------------------------+
| PIO2_3        | SDIF     | SD card clock           |
+---------------+----------+-------------------------+
| PIO2_4        | SDIF     | SD card command         |
+---------------+----------+-------------------------+
| PIO2_5        | SDIF     | SD card power enable    |
+---------------+----------+-------------------------+
| PIO2_6-PIO2_9 | SDIF     | SD card data D0-D3      |
+---------------+----------+-------------------------+
| PIO2_10       | SDIF     | SD card detect          |
+---------------+----------+-------------------------+
| PIO3_3        | GPIO     | User LED2               |
+---------------+----------+-------------------------+
| PIO3_4        | GPIO     | Accelerometer INT1      |
+---------------+----------+-------------------------+
